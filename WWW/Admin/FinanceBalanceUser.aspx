<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FinanceBalanceUser.aspx.cs" Inherits="Admin_FinanceBalanceUser" %>
        ...
        <div class="main">
            <div class="maincon">
                ...
                <div class="finanbalan_wrap">
                                    ...
                                    <td class="edit" style="border-right: 1px solid #dfdfdf;">
                                        ...
                                        <td>
                                            <% if (SourceFrom.Equals("Group"))
                                               { %>
                                            <a href="FinanceBalanceUser.aspx?SourceFrom=Agent&ParentName=<%#Eval("Name")%>&groupid=<%#Eval("GroupUserId")%>"><%#Eval("Name")%>（<%#Eval("cnt")%>）</a>
                                            <% }else{ %>
                                            <a href="UserAccountDetail.aspx?SiteID=1&ID=<%#Eval("GroupUserId")%>&UserName=<%#Eval("Name")%>"><%#Eval("Name")%></a>
                                            <% } %>
                                        </td>
                                        <td>
                                            <%#Eval("NickName") %>
                    ...
                    <div id="div_chart" runat="server" style="text-align: center; margin-bottom: 20px; width: 96%; margin: 30px auto">
                        <div style="width: 800px;">
                            <table class="table_chart" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <%=TDS %>
                                    <td rowspan="2" valign="top" style="width: 35%; text-align: left; border: none">
                                        <%=Divs%>
                                    </td>
                                </tr>
                            </table>
