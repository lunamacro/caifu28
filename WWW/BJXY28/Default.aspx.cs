...
public partial class BJXY28_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(BJXY28_Default), this.Page);
            BindWinRakking();
            GetNewsInfo(98);
    ...
    {
        string CacheKey = "JNDXY28_OpenWinInfo";
    ...
    private void BindWinRakking()
    {
        ...
        DataTable dt = Shove._Web.Cache.GetCacheAsDataTable("SQLDefault_WinRanking98");
