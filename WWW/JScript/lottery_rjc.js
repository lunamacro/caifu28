...
function changeTZWay(tag) {
    ...
    switch (tag) {
        case "pttz":        //普通投注
            ...
            break;
        case "dssc":        //单式上传
            $("#updateFrame").attr("src", "/Home/Room/SchemeUpload.aspx?id=75&PlayType=7501&Isuse=" + $("#currentIssueId").val());
...
var PTTZ = {
        ...
        */
        $("#clearAllSelect").click(function () {
            ...
            if ("pttz" == tzWay) {
                ...
                var okfunc = function () { $("#txt_schemeList").val(""); $("#txt_schemeList").focus(); };
                var cancelfunc = function () { };
        ...
        */
        $("#btnTZ").click(function () {
            ...
            if ("dg" == buyWay) {
                ...
                AssureMoney = AssureShare * (Lottery.GetSumMoney() / TotalShare); //AssureShare * EachShareMoney; //保底金额
                SchemeBonusScale = parseFloat($("#pttz_fatc b[class='active']").attr("tag"));
            }
            PTTZBuy.LotName = "任九场";                                //彩种名称
            PTTZBuy.LotteryID = lotID;                                  //彩种ID
            PTTZBuy.IsuseID = $("#currentIssueId").val();              //期号ID						
            PTTZBuy.PlayTypeID = "7501";                               //玩法ID
            ...
            if ("fqhsc" == buyWay) {
                ...
                PTTZBuy.AssureMoney = FQHSC.MyBD * (PTTZBuy.SumMoney / PTTZBuy.TotalShare); //保底金额
    ...
    */
    CheckSelectNumber: function () {
        ...
        if (len > 8) {
            ...
            if (lotteryNumber.split("-").length < 6) {
                var al_content = new Array();
                var SchemeContent = ["", "", "", "", "", "", "", "", "", "", "", "", "", ""];
                var LotteryContent = "";
                var len = lotteryNumber.split("-").length;
                Lot_Num = 0;
                if (lotteryNumber.split(")").length == 1) {
                    for (var i_1 = 0; i_1 < 14; i_1++) {
                        SchemeContent[i_1] = lotteryNumber.substr(i_1, 1);
                    }
                }
                else {
                    var ArrContent = lotteryNumber.split(")");
                    var i_3 = 0;
                    for (var i_1 = 0; i_1 < ArrContent.length; i_1++) {
                        for (var i_2 = 0; i_2 < ArrContent[i_1].length; i_2++) {
                            if (ArrContent[i_1].substr(i_2, 1) == "(") {
                                SchemeContent[i_3] = ArrContent[i_1].substr(i_2 + 1, ArrContent[i_1].length - i_2 - 1);
                                i_3++;
                                break;
                            }
                            else {
                                SchemeContent[i_3] = ArrContent[i_1].substr(i_2, 1);
                                i_3++;
                            }
                        }
                    }
                ...
                switch (len) {
                    case 5:
                        for (var i_1 = 0; i_1 < 14; i_1++) {
                            if (SchemeContent[i_1] != "-") {
                                LotteryContent = "";
                                for (var i_2 = 0; i_2 < i_1; i_2++) {
                                    if (SchemeContent[i_2].length > 1) {
                                        LotteryContent += "(" + SchemeContent[i_2] + ")";
                                    }
                                    else {
                                        LotteryContent += SchemeContent[i_2];
                                    }
                                ...
                                al_content.push(LotteryContent);
                            }
                        }
                        break;
                    case 4:
                        for (var i_1 = 0; i_1 < 14; i_1++) {
                            for (var i_2 = i_1 + 1; i_2 < 14; i_2++) {
                                if (SchemeContent[i_1] != "-" && SchemeContent[i_2] != "-") {
                                    LotteryContent = "";
                                    for (var i_3 = 0; i_3 < i_1; i_3++) {
                                        if (SchemeContent[i_3].length > 1) {
                                            LotteryContent += "(" + SchemeContent[i_3] + ")";
                                        }
                                        else {
                                            LotteryContent += SchemeContent[i_3];
                                        }
                    ...
                    case 3:
                        for (var i_1 = 0; i_1 < 14; i_1++) {
                            for (var i_2 = i_1 + 1; i_2 < 14; i_2++) {
                                for (var i_4 = i_2 + 1; i_4 < 14; i_4++) {
                                    if (SchemeContent[i_1] != "-" && SchemeContent[i_2] != "-" && SchemeContent[i_4] != "-") {
                                        LotteryContent = "";
                                        for (var i_3 = 0; i_3 < i_1; i_3++) {
                                            if (SchemeContent[i_3].length > 1) {
                                                LotteryContent += "(" + SchemeContent[i_3] + ")";
                    ...
                    case 2:
                        for (var i_1 = 0; i_1 < 14; i_1++) {
                            for (var i_2 = i_1 + 1; i_2 < 14; i_2++) {
                                for (var i_4 = i_2 + 1; i_4 < 14; i_4++) {
                                    for (var i_5 = i_4 + 1; i_5 < 14; i_5++) {
                                        if (SchemeContent[i_1] != "-" && SchemeContent[i_2] != "-" && SchemeContent[i_4] != "-" && SchemeContent[i_5] != "-") {
                                            LotteryContent = "";
                                            for (var i_3 = 0; i_3 < i_1; i_3++) {
                                                if (SchemeContent[i_3].length > 1) {
                                                    LotteryContent += "(" + SchemeContent[i_3] + ")";
                    ...
                    case 1:
                        for (var i_1 = 0; i_1 < 14; i_1++) {
                            for (var i_2 = i_1 + 1; i_2 < 14; i_2++) {
                                for (var i_4 = i_2 + 1; i_4 < 14; i_4++) {
                                    for (var i_5 = i_4 + 1; i_5 < 14; i_5++) {
                                        for (var i_6 = i_5 + 1; i_6 < 14; i_6++) {
                                            if (SchemeContent[i_1] != "-" && SchemeContent[i_2] != "-" && SchemeContent[i_4] != "-" && SchemeContent[i_5] != "-" && SchemeContent[i_6] != "-") {
                                                LotteryContent = "";
                                                for (var i_3 = 0; i_3 < i_1; i_3++) {
                                                    if (SchemeContent[i_3].length > 1) {
                                                        LotteryContent += "(" + SchemeContent[i_3] + ")";
                ...
                for (var j = 0; j < al_content.length; j++) {
                    var LotteryNumber = al_content[j];
                    var count = 1;
                    if (LotteryNumber.split(")").length > 1) {
                        var ArrContent = LotteryNumber.split(")");
                        for (var i_1 = 0; i_1 < ArrContent.length; i_1++) {
                            for (var i_2 = 0; i_2 < ArrContent[i_1].length; i_2++) {
                                if (ArrContent[i_1].substr(i_2, 1) == "(") {
                                    count *= ArrContent[i_1].substr(i_2 + 1, ArrContent[i_1].length - i_2 - 1).length;
                                    break;
                                }
                            }
                        }
    ...
    */
    AddLotteryNumberToNumberList: function () {
        ...
        for (var i = 0; i < trLen; i++) {
            ...
            //如果一注投注号码长度太长了，在号码列表中放不下，会换行，所以超出的长度使用...来代替
    ...
    */
    DSSC: function () {
        ...
        for (var i = 0; i < len; i++) {
            ...
            if (reg.test(numberList[i]) && numberList[i].length == 14 && numberList[i].split("-").length == 6) {
        ...
        if (len > 0) {
            ...
            for (var i = 0; i < len; i++) {
                ...
                lis += "<li title=" + temp + "[" + 1 + "注，" + 1 * 2 + "元]" + " lotteryNumber = '" + _temp + "'><p><b>" + dfs + "</b><b class=\"col-red\"> " + temp + " </b>[<span tag='zs'>" + 1 + "注</span>，" + 1 * 2 + "元]</p><a href='javascript:;' onclick='deleteSelectNumber(this)'>删除</a></li>";

            }
            $("#selectNumberList").prepend(lis);
            PTTZ.ClearAllSelect();
        }
    ...
    */
    JX1Z: function () {
        ...
        for (var i = 0; i < 14; i++) {
            if (tempLen < 5) {
                temp = number[Math.round(Math.random() * 3)];
            } else {
                temp = number[Math.round(Math.random() * 2)];
            }
            if ("-" == temp) {
                tempLen++;
            } else {
...
var YX5Z = {
    InitEvent: function () {
        ...
        */
        $("#yt5zTZ").click(function () {
            ...
            YX5ZBuy.AssureShare = parseFloat($("#yx5z_hm_assureShare").val());                          //保底多少份
            YX5ZBuy.AssureMoney = parseFloat($("#yx5z_hm_assureShare").val());         //保底金额
    ...
    */
    CalculateYX5ZHMInfo: function () {
        ...
        //-------------------------赋值合买购买参数-------------------------\\
        YX5ZBuy.LotName = "任九场";                                 //彩种名称
        YX5ZBuy.LotteryID = lotID;                                   //彩种id
        YX5ZBuy.IsuseID = $("#currentIssueId").val();               //期号id
        YX5ZBuy.PlayTypeID = "7501";                                //玩法id
        YX5ZBuy.Title = $("#yx5z_hm_schemeTitle").val();            //方案标题
        YX5ZBuy.Description = $("#yx5z_hm_schemeDesc").val();       //方案描述
        YX5ZBuy.SchemeContent = "";                                 //方案内容，预选5注不需要上传方案内容，但是isNullBuyContent这个参数值必须传递“1”
        ...
        $.ajax({
            ...
            success: function (result) {
                if (parseInt(result.error, 10) > 0) {//购买成功
                    ...
                    location.href = "/UserLogin.aspx?RequestLoginPage=RJC/Default.aspx";
                    return;
                } else {
                    alert(result.msg);
                    //订单防重复处理
...
function Combination(m, n) //算组合数，m中取n
{
    var sum = 1; //线性计算
    for (var i = 1, j = m; i <= n; i++, j--)
        sum = sum * j / i;
    return sum;
}
