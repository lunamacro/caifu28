var Lottery = {
    ...
    SelectBall: function (obj, Type) {
        ...
        //-----时时乐、重庆时时彩 组三------------------start
        if (this.PlayTypeID == 2905 || this.PlayTypeID == 2811 || this.PlayTypeID == 6111) {
        ...
        if (Lottery.PlayTypeID == 6809 || Lottery.PlayTypeID == 6814) {
            if (this.GetBallState(obj, 4)) {
                ...
                if ((this.getSelectedRedBallCount() <= 3 && Lottery.PlayTypeID == 6809) || (this.getSelectedRedBallCount() <= 2 && Lottery.PlayTypeID == 6814)) {
                    if (this.GetBallState(obj, 1)) {
                        obj.removeClass("rball");
                        obj.addClass("bball");
                ...
                if (this.getSelectedRedBallCount() <= 2 || this.getSelectedRedBallCount() <= 1) {
                    if (this.GetBallState(obj, 1)) {
                    ...
                    if (this.GetBallState(obj, 1)) {
                        ...
                        if (obj.parent().find("b.bball").length == 1) {
                            if ((Lottery.PlayTypeID == 6809 && this.getSelectedRedBallCount() > 2) || (Lottery.PlayTypeID == 6814 && this.getSelectedRedBallCount() > 1)) {
                                obj.parent().find("b.bball").addClass("rball");
                                obj.parent().find("b.bball").removeClass("bball");
                            }
                        }
        ...
        if (Lottery.LotID == 61) {
            ...
            //-----江西时时彩 五星复选----------start
            if (Lottery.PlayTypeID == 6102 || Lottery.PlayTypeID == 6109) {
                if (this.GetBallState(obj, 1)) {
                    obj.removeClass("rball");
                } else {
                    obj.parent().children("b.rball").removeClass("rball");
    ...
    GetLotteryNumber: function () {
        ...
        switch (this.PlayTypeID) {
            ...
            case 6102:
                //江西时时彩-五星复选-取号码
            case 6103: //江西时时彩-五、四,三、二、一星直选-取号码
            case 6105: //江西时时彩-五星通选-取号码
                $("#tz_jxssc ul:visible").each(function (i, n_ul) {
                    var temp = "";
                    $(n_ul).find("b.rball").each(function (i, n_b) {
                        temp += $.trim($(n_b).text());
                    });
                ...
                for (var i = 0; i < 5 - $("#tz_jxssc ul:visible").length; i++) {
                    tmpLotteryNumber = "-" + tmpLotteryNumber;
                }

                break;
            case 6106: //江西-二星组选-取号码
                tmpLotteryNumber = this.getSelectedRedBallText("");
                break;
            case 6108:
            case 6109:
            case 6110: //江西时时彩-二星直选包点-取号码
                tmpLotteryNumber = this.getSelectedRedBallText(",");
                break;
            case 6104: //江西时时彩-大小单双-取号码
                $("#div_daxiao_danshuang ul").each(function (i, n_ul) {
                    var temp = "";
                    $(n_ul).find("b.rball").each(function (i, n_b) {
                        temp += $.trim($(n_b).text()) + ",";
            ...
            case 6113: //江西时时彩-任选一
                ...
                for (var i = 0; i < 5; i++) {
                    var temp = "";
                    var obj = $($("#tz_jxssc ul")).eq(i).find(".rball");
                    for (var j = 0; j < obj.length; j++) {
                        if ($(obj[j]).is(".rball"))
                            temp += $.trim($(obj[j]).text());
                    }
                    if (temp.length > 1) {
                        temp = "(" + temp + ")";
                    }
                ...
                tmpLotteryNumber = $.trim(LotteryNumber);
            ...
            case 6809: //组12普通投注
                if ($("#div_zuxuanputongtouzhu").find("b.bball").length == 1) {
                    ...
                    tmpLotteryNumber = vBlue + vBlue + this.getSelectedRedBallText("");
                }
                else {
                    tmpLotteryNumber = this.getSelectedRedBallText("");
                }
            ...
            case 6814: //组4普通投注
                if ($("#div_zuxuanputongtouzhu").find("b.bball").length == 1) {
                    var vBlue = $("#div_zuxuanputongtouzhu").find("b.bball").text();
                    tmpLotteryNumber = vBlue + vBlue + vBlue + this.getSelectedRedBallText("");
                }
                else {
                    tmpLotteryNumber = this.getSelectedRedBallText("");
                }
            ...
            case 6815: //组4胆拖投注
            case 6816: //组4重胆拖投注
                $("#div_dantuo_chongdantuo ul").each(function (i, n_ul) {
                    var temp = "";
                    if ($(n_ul).find("b.rball").length < 1) {
                        temp += "-";
                    } else {
    ...
    GetLotteryInvestNum: function () {
        ...
        switch (this.PlayTypeID) {
            ...
            case 501: //双色球-普通投注-取注数
                ...
                break;
            case 502: //双色球-胆拖-取注数
                if (this.getSelectedRedBallCount() + this.getSelectedTuoBallCount() < 6 || this.getSelectedBlueBallCount() < 1) {
                    InvestNum = 0;
                } else {
            ...
            case 3904: //大乐透-追加胆拖-取注数
                ...
                if (this.getSelectedRedBallCount() < 1 || this.getSelectedTuoBallCount() < 2 || this.getSelectedRedBallCount() + this.getSelectedTuoBallCount() < 5 || this.getSelectedBlueBallCount() < 2) {
                    InvestNum = 0;
                }
                else {
            ...
            case 6102:
                //江西时时彩-五星复选-取注数
                InvestNum = 5;
                $("#tz_jxssc ul").each(function (i, n_ul) {
                    InvestNum *= $(n_ul).find("b.rball").length;
                });
                break;
            case 6103: //江西时时彩-五、三、二、一星直选-取注数
            case 6105: //江西时时彩-五星通选-取注数
                InvestNum = 1;
                $("#tz_jxssc ul:visible").each(function (i, n_ul) {
                    InvestNum *= $(n_ul).find("b.rball").length;
                });
                break;
            case 6106: //重庆时时彩-二星组选-取注数
                //  InvestNum = this.getSelectedRedBallCount() < 2 ? 0 : this.Combination(this.getSelectedRedBallCount(), 2);
                InvestNum = GetLotteryInvestNum_JXSSC_RX2();
                break;
            case 6108:
            case 6109:
            case 6110: //重庆时时彩-二星直选包点-取注数
                InvestNum = 0;
                var invest_context = this.getSelectedRedBallText(",");
                var investStrs = invest_context.split(",");
                for (var i = 0; i < investStrs.length; i++) {
                ...
                break;
            case 6104: //江西时时彩-大小单双-取注数
                InvestNum = 1;
                $("#div_daxiao_danshuang ul").each(function (i, n_ul) {
                    InvestNum *= $(n_ul).find("b.rball").length;
                });
                break;
            case 6111: //重庆时时彩-三星组三-取注数
                if (this.getSelectedRedBallCount() == 1 && $("#div_3xing_zu3_zu6_zuhe").find("b.bball").length == 1) {
                    InvestNum = 1;
                } else {
                    InvestNum = this.getSelectedRedBallCount() < 3 ? 0 : this.getSelectedRedBallCount() * (this.getSelectedRedBallCount() - 1);
    ...
    CalcSumMoney: function () {
        ...
        //        if (Lottery.LotID == 61 || Lottery.LotID == 28 || Lottery.LotID == 78 || Lottery.LotID == 62 || Lottery.LotID == 70) {
        //            var zhao_li = 0; //获得追号期数
        ...
        //            if (Lottery.LotID == 61 || Lottery.LotID == 83 || Lottery.LotID == 28 || Lottery.LotID == 62 || Lottery.LotID == 70 || Lottery.LotID == 29) {
        //                if ($("#CoBuy").is(":checked")) {

        //                    $("#lab_ShareMoney").text(parseInt($("#LbSumMoney").text()) / (StrToInt($("#tb_Share").val())).toFixed(2));
        //                } else {

        //                    $("#lab_ShareMoney").text((this.TotalMoney * zhao_li / StrToInt($("#tb_Share").val())).toFixed(2));
        //                }
        //            }
        //            else {
    ...
    MustBeLegalKey: function () {
        ...
        if (this.PlayTypeID == 6113 || this.PlayTypeID == 6114) {
    ...
    //合买追号
    ChaseBuyWay: function () {

        if ($("#CoBuy").is(":checked")) {
            //合买
            //  var Opt_InitiateSchemeLimitUpperScale = StrToFloat($("#HidOpt_InitiateSchemeLimitUpperScale").val());
            var HiOpt_InitiateSchemeMinBuyAndAssureScale = StrToFloat($("#HidOpt_InitiateSchemeLimitUpperScaleMoney").val());
    ...
    ValidateShareSpilt: function () {
        ...
        if (Share < 0) {
            ...
            if (Share > 1) {
                ...
                //                if (Lottery.LotID == 61 || Lottery.LotID == 28 || Lottery.LotID == 78 || Lottery.LotID == 62 || Lottery.LotID == 70)//如果是江西时时彩
                //                {
                //                    var indes_lis = 0;
                //                    $("#div_QH_Today input:checkbox").each(function (i, n) {
                //                        if ($(n).is(":checked")) {
                ...
                //                        }
                //                    })
                //                    if (indes_lis > 0) {//大于0说明有选择追号

                //                        SumMoney = $("#LbSumMoney").text();
                //                        ShareMoney = SumMoney / Share;
                //                        ShareMoney2 = Math.round(ShareMoney * 100) / 100;
                //                    }
                //                }
        ...
        if (!OK) {
            ...
            confirm("份数为 0 或者不能除尽，将产生误差，并且金额不能小于 1 元。按“确定”重新输入，按“取消”自动更正为 1 份，请选择。", okfunc, cancelfunc);
            return;
        }
    ...
    ValidateInitIDBuyShare: function () {
        ...
        if ((BuyShare < 1) || (BuyShare > Share)) {
            ...
            confirm("购买份数不能为 0 以及大于总份数同时份数必须为整数。按“确定”重新输入，按“取消”自动更正为 " + Share + " 份，请选择。", okfunc, cancelfunc);
            return;
        }
    ...
    ValidateAssureShare: function () {
        ...
        if (AssureShare > (Share - 1)) {
            ...
            var okfunc = function () { $("#tb_AssureShare").focus(); };
            var cancelfunc = function () {
    ...
    ChaseCalculateTotalMoney: function () {
        ...
        $("#div_QH_Today input:checkbox").each(function (i, n) {
            if ($(this).is(":checked")) {
                ...
                multiple += parseInt($("#" + $(this)[0].id.replace("check", "times")).val());
                chaseCount++;
            }
        });
        $("#spanChaseIsuseCount").html(chaseCount);
    ...
    Submit: function () {
        ...
        var SumMoney = $("#lab_SumMoney").text();
        var SchemeContent = "";
        //        if (this.LotID == "61" || this.LotID == "28" || this.LotID == "78" || this.LotID == "62" || this.LotID == "70") {//江西时时彩
        //            var zhao_li = 0;
        //            if ($("#CoBuy").is(":checked")) {
        //                $("#div_QH_Today input:checkbox").each(function (i, n) {
        //                    if ($(n).is(":checked")) {
        ...
        //                    }
        //                }) //获得追号期数
        //                if (parseInt(zhao_li) > 0) {//追号复选大于0
        //                    SumMoney = $("#LbSumMoney").text();
        //                }
        //                else {
        //                    SumMoney = $("#lab_SumMoney").text();
        //                }
        //            }
        //        }
        ...
        //        var zhuihao_li = false;
        //        if (Lottery.LotID == 61 || Lottery.LotID == 28 || Lottery.LotID == 78 || Lottery.LotID == 62 || Lottery.LotID == 70) {//江西时时彩是否追号
        //            if (!$("#CoBuy").is(":checked")) {
        //                $("#div_QH_Today input:checkbox").each(function (i, n) {
        //                    if ($(n).is(":checked")) {
        //                        zhuihao_li = true;
        ...
        //根据购买方式拼凑数据
        if ($("#Chase").is(":checked")) {//追号----zhuihao_li是江西时时彩
            if (StrToInt($("#LbSumMoney").text()) > 0) {
                ...
                if ($("#Chase").is(":checked")) {
                    ...
                    TipStr += "　　总金额：　" + $("#lab_SumMoney").text() + " 元\n\n";
                }
                var okfunc = function () { };
                var cancelfunc = function () { this.ChangeSubmitButtonState(true); };
                confirm(TipStr + "按“确定”即表示您已阅读《用户投注协议》并立即提交代购方案，确定要提交投注方案吗？", okfunc, cancelfunc);
                return;
            }
            else {
                this.ChangeSubmitButtonState(true);
            ...
            //初始化四个值
            var Opt_InitiateSchemeLimitLowerScaleMoney = $("#HidOpt_InitiateSchemeLimitLowerScaleMoney").val();
            var Opt_InitiateSchemeLimitLowerScale = $("#HidOpt_InitiateSchemeLimitLowerScale").val();
            var Opt_InitiateSchemeLimitUpperScaleMoney = $("#HidOpt_InitiateSchemeLimitUpperScaleMoney").val();
            var Opt_InitiateSchemeLimitUpperScale = $("#HidOpt_InitiateSchemeLimitUpperScale").val();
            ...
            if ((BuyShare) < Math.round(TotalShare * Opt_InitiateSchemeLimitScale)) {
                if (Opt_InitiateSchemeLimitLowerScale == Opt_InitiateSchemeLimitUpperScale) {
                    msg("发起人最少必须认购 " + (Opt_InitiateSchemeLimitLowerScale * 100) + "%。(" + Math.round(TotalShare * Opt_InitiateSchemeLimitLowerScale) + ' 份， ' + (Math.round(TotalShare * Opt_InitiateSchemeLimitLowerScale) * StrToFloat($("#lab_ShareMoney").text())) + ' 元)');
                }
                else {
                    msg("此方案发起人认购(不含保底)最少必须达到 " + Math.round(TotalShare * Opt_InitiateSchemeLimitScale) + " 份。\r\n\r\n" +
                    "发起方案最少认购比例说明：\r\n" +
        ...
        //                        $("#div_QH_Today input:checkbox").each(function(i,n) {
        //                            if ($(this).is(":checked")) {
        //                                post_data.ChaseContent += $(this).val() + "," + $("#times" + $(this).val()).val() + "," + $("#money" + $(this).val()).val() + ";";
        //                            }
        //                        });
        //                        post_data.ChaseContent = post_data.ChaseContent.substring(0, post_data.ChaseContent.length - 1);
        ...
        if (bool_b) {//江西合买追号入口
            ...
            var sun = $("#hidPalyId").val();
            if (sun == 7) {
                post_data.PlayTypeID = 6119;
            } else if (sun == 8) { post_data.PlayTypeID = 6120; }

            $.ajax({
                type: "post",
                url: "/Ajax/ChaseBuy.ashx",
                data: post_data,
                cache: false,
                async: false,
                dataType: "json",
...
var CodeArea = {
    ...
    AddTextToCodeArea: function () {
        if (Lottery.PlayTypeID == 8213 || Lottery.PlayTypeID == 8212 || Lottery.PlayTypeID == 8214) {
