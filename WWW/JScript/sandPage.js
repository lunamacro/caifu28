...
var sand = {
    ...
    gopageWrapId: 'sand_gopage_wrap',
    gopageButtonId: 'sand_btn_go',
    gopageTextboxId: 'sand_btn_go_input',
    ...
    generPageHtml: function () {
        ...
        if (this.isGoPage) {
            gopage_info = '&nbsp;' + this.lang.gopageBeforeText + '<span id="' + this.gopageWrapId + '">' +
					'<input type="button" id="' + this.gopageButtonId + '" onclick="sand.gopage()" value="'
						+ this.lang.gopageButtonOkText + '" />' +
					'<input type="text" id="' + this.gopageTextboxId + '" onfocus="sand.focus_gopage()"  onkeypress="return sand.keypress_gopage(this);"   onblur="sand.blur_gopage()" value="' + this.next + '" onchange="if(!sand.keypress_gopage(this)){ $(this).val(sand.next);}" /></span>' + this.lang.gopageAfterText;
        }
