<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="JND28_Default" %>
...
<head id="Head1" runat="server">
    <title>加拿大幸运28 - <%=_Site.Name %></title>
...
<body>
    <form id="form1" runat="server" onsubmit="return false">
        ...
        <div class="main lottery" id="ssc">
            <!-- 招牌 -->
            <div class="signage">
                <img class="logo" width="65" src="../Images/jndpc28.png">
                <div class="left">
                    <h1>加拿大幸运28</h1>
                    <p>
                        全天；每3.5分钟一期
            ...
            <div class="content clear">
                ...
                <div class="help right">
                    ...
                    <div class="notice border-gray" style="margin-bottom: 10px;">
                        <div class="kjgg_top">
                            <span class="kjgg_top_gongg">开奖公告</span> <a href="../WinQuery/DetailsGaoPin.aspx?ID=98" target="_blank">更多</a>
                        </div>
                        <p id="news-open-info">
