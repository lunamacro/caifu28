...
public partial class CPS_Promote_PromoteDate : CPSPromoteBase
{
    ...
    private void BindData()
    {
        ...
        DataTable table = new DAL.Tables.T_CpsAdminAccountByMonth().Open("ID,[Year],[Month],BuyMoney,PayBonus,IsPayOff", "OwnerUserID = " + _User.ID + " and [Year] = " + ddlYear.SelectedValue, "[Year],[Month]");
    ...
    {
        string paramStr = "PromoteCommission.aspx?startDate={0}&endDate={1}";
        DateTime now = DateTime.Now;
