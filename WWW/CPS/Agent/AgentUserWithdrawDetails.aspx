<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgentUserWithdrawDetails.aspx.cs"
...
<head id="Head1" runat="server">
    ...
    <title>
        <%=_Site.Name %>-推广联盟-取款明细</title>
    <meta name="description" content="<%=_Site.Name %>-推广联盟-取款明细" />
    <meta name="keywords" content="<%=_Site.Name %>-推广联盟-取款明细" />
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="user_banner">
            <h3>取款明细<span>BuyLottery Details</span></h3>
        </div>
        <div class="content">
            <div class="inside_bg">
                <div class="insicon">
                    <div class="sidebar">
                        <ul>
                            <li class="curr"><a href="javascript:void(0);" onclick="location.reload()">取款明细</a></li>
                        </ul>
                    </div>
                    <div class="commain">
                        <div class="mainbor">
                            <div id="user_list" class="number_record">
                                ...
                                <div class="num_search" runat="server" id="divSearch">
                                    <ul>
                                        ...
                                        <li>
                                            <input type="button" id="btnSearch" value="确定" class="btnAction" />
                                        </li>
                                    </ul>
                                </div>
                                <dl>
                                    ...
                                    <asp:Repeater runat="server" ID="rpt_list" OnItemDataBound="rpt_list_ItemDataBound">
                                        <ItemTemplate>
                                            <dd>
                                                ...
                                                <div style="width: 20%; text-align: center;">                                                   
                                                    <%#Eval("HandleDateTime")%></a>
                                                </div>
                                                <div style="width: 20%; text-align: center;">
                                                    <%#Shove._Convert.StrToDouble(Eval("Balance").ToString(), 0).ToString("0.00")%>
                                                </div>
                                            </dd>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                    <dd>
                                        ...
                                        <div style="width: 20%; text-align: center; color: Red;">
                                            <%=sumMoney.ToString("0.00") %>
                                        </div>
                                        <div style="width: 20%; text-align: center;">
                                            -
                                        </div>
                                        <div style="width: 20%; text-align: center; color: Red;">
                                            <%=sumBalance.ToString("0.00") %>
                                        </div>
                                    </dd>
                                </dl>
        ...
        <input type="hidden" id="hideOrder" value="DateTime" runat="server" />
