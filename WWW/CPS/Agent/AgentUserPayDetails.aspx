<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgentUserPayDetails.aspx.cs"
...
<head id="Head1" runat="server">
    ...
    <title>
        <%=_Site.Name %>-推广联盟-存款明细</title>
    <meta name="description" content="<%=_Site.Name %>-推广联盟-存款明细" />
    <meta name="keywords" content="<%=_Site.Name %>-推广联盟-存款明细" />
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="user_banner">
            <h3>存款明细<span>BuyLottery Details</span></h3>
        </div>
        <div class="content">
            <div class="inside_bg">
                <div class="insicon">
                    <div class="sidebar">
                        <ul>
                            <li class="curr"><a href="javascript:void(0);" onclick="location.reload()">存款明细</a></li>
                        </ul>
                    </div>
                    <div class="commain">
                        <div class="mainbor">
                                    ...
                                    <asp:Repeater runat="server" ID="rpt_list" OnItemDataBound="rpt_list_ItemDataBound">
                                        <ItemTemplate>
                                            <dd>
                                                ...
                                                <div style="width: 20%; text-align: center;">
                                                    <%#Shove._Convert.StrToDouble(Eval("HandselMoney").ToString(), 0).ToString("0.00")%>
                                                </div>
                                            </dd>
                                        </ItemTemplate>
                                    </asp:Repeater>
