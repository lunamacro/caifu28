<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgentPromoteList.aspx.cs"
    Inherits="CPS_Agent_AgentPromoteList" %>
...
<head id="Head1" runat="server">
    ...
    <title>
        <%=_Site.Name %>-推广联盟-代理工作室</title>
    <meta name="description" content="<%=_Site.Name %>-推广联盟-推广员列表" />
    <meta name="keywords" content="<%=_Site.Name %>-推广联盟-推广员列表" />
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="user_banner">
            <h3>代理工作室<span>My Members</span></h3>
        </div>
        <div class="content">
            <div class="inside_bg">
                <div class="insicon">
                    <div class="sidebar">
                        <ul>
                            <li style="display:none"><a href="AgentNumber.aspx">会员列表</a></li>
                            <li class="curr"><a href="AgentPromoteList.aspx">代理工作室</a></li>
                        ...
                        <tbody>
                            <asp:Repeater ID="rptSchemes" runat="server" EnableViewState="false">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <a href="AgentPromoteNumber.aspx?SourceFrom=Group&ParentName=<%#Eval("Name")%>&groupid=<%#Eval("GroupUserId")%>"><%#Eval("Name")%>（<%#Eval("cnt")%>）</a>
                                        </td>
                                        <td>
                                            <%#Eval("NickName") %>
                                        </td>
