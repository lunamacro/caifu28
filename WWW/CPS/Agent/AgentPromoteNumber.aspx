<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgentPromoteNumber.aspx.cs"
    Inherits="CPS_Agent_AgentPromoteNumber" %>
...
<head id="Head1" runat="server">
    ...
    <title>
        <%=_Site.Name %>-推广联盟-推广员发展的会员</title>
    <meta name="description" content="<%=_Site.Name %>-推广联盟-推广员发展的会员" />
    <meta name="keywords" content="<%=_Site.Name %>-推广联盟-推广员发展的会员" />
                                    ...
                                    <td class="edit" style="border-right: 1px solid #dfdfdf;">
                                        ...
                                        <td>
                                            <% if (SourceFrom.Equals("Group"))
                                               { %>
                                            <a href="AgentPromoteNumber.aspx?SourceFrom=Agent&ParentName=<%#Eval("Name")%>&groupid=<%#Eval("GroupUserId")%>"><%#Eval("Name")%>（<%#Eval("cnt")%>）</a>
                                            <% }else{ %>
