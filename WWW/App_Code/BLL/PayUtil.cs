...
namespace UlinePayUtil
{
    ...
    {
        Log log = new Log("PayUtil");
        string key = "";
        public PayUtil(string key)
        {
            this.key = key;
        }
        ...
        **/
        public string ToXml()
        {
            ...
            foreach (KeyValuePair<string, object> pair in m_values)
            {
                ...
                if (pair.Value == null)
                {
                    log.Write("WxPayData内部含有值为null的字段!");
        ...
        */
        public string ToPrintStr()
        {
            ...
            log.Write("Print in Web Page : " + str);
            return str;
        }
