...
namespace SLS
{
    public partial class Lottery
    {
        ...
        /// 北京幸运28
        /// </summary>
        public partial class BJXY28 : LotteryBase
        {
            //注：加 * 号的为使用中的玩法
            #region 静态变量
            private const int PlayType_DX = 9901;
            private const int PlayType_CaiShuZi = 9902;
            private const int PlayType_TeShu = 9903;

            public const int ID = 99;
            private const string Name = "北京幸运28";
            private const string Code = "BJXY28";
            #endregion
            ...
            {
                return ((play_type >= 9901) && (play_type <= 9903));
            }
